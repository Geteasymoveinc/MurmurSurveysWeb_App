...
import Downgrade from "../../assets/images/downgrade.png";
import "../../assets/css/modals/modal.scss";

class DowngradeSubscription extends React.Component {
          ...
          <Row>
            <Col className="d-flex flex-column align-items-center pl-4 pr-4">
              <div className={`${classes.uploader}`}>
                <img src={Downgrade} alt="" className="mb-4" />
              </div>

              <h5>Downgrading your subscription</h5>
