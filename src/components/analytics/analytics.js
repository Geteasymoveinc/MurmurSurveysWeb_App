...
import HeadSearch from '../CommonForBoth/Headsearch'
...
import Impressions_and_Views from "../../assets/charts/impressionsAndViews";
       ...
       console.log(data)
        ...
        this.setState({
          ...
          audience: {
            ...
            views_total: people_reached_views_total,
            people_reached,
            analytics_date,
            impressions,
            views
