...
import check from "../../assets/css/Settings/grncheck.svg";
          ...
          <ModalBody>
            <form>
              <div className="form_element_modal">
                <label htmlFor="reason_cancel">
                  Reason of the Cencelation:
                </label>
            ...
            <ModalBody>
              <div className="plan_modal_cover">
                ...
                <input
                  ...
                  name="modal-run"
                  id="plan_run"
                  onChange={() => this.billingPackageChange('Run')}
