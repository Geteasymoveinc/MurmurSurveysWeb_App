...
import { updateResearchMainSettings } from "../../../store/actions";

import axios from "axios";
import { connect } from "react-redux";

class ResearchSetting extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
      constructResearch: {
        ...
        targetUsersFrom: this.props.targetUsersFrom,
        researchConductedVia: this.props.researchConductedVia,
      },
  ...
  componentDidUpdate(prevProps) {
    if (
      prevProps.research === this.props.research &&
      prevProps.researchConductedVia === this.props.researchConductedVia &&
      prevProps.targetUsersFrom === this.props.targetUsersFrom
    ) {
      return;
    }
    this.setState((state) => ({
            ...
            <div className={classes.surveys_container}>
              ...
              >
                <div className={classes.services}>
                  <div
                    className={`${classes.services__service} ${
                      this.state.constructResearch.research === "uiux-design"
                        ? classes["services__service--active"]
                        : null
                    }`}
                  >
                    <h5>
                      ...
                      <button
                        onClick={() => {
                          //this.enrollParticipants("uiux-design");
                  ...
                  <div
                    className={`${classes.services__service} ${
                      this.state.constructResearch.research === "ecommerce"
                        ? classes["services__service--active"]
                        : null
                    }`}
                  >
                    <h5>
                      ...
                      <button
                        onClick={() => {
                          //this.enrollParticipants("ecommerce");
                          this.props.updateResearchMainSettings(
                            "research",
                            "ecommerce"
                          );
                  ...
                  <div
                    className={`${classes.services__service} ${
                      this.state.constructResearch.research === "product"
                        ? classes["services__service--active"]
                        : null
                    }`}
                  >
                    <h5>
                      ...
                      <button
                        onClick={() => {
                          //this.enrollParticipants("product");
                          this.props.updateResearchMainSettings(
                            "research",
                            "product"
                          );
                  ...
                  <div
                    className={`${classes.services__service} ${
                      this.state.constructResearch.research === "hr"
                        ? classes["services__service--active"]
                        : null
                    }`}
                  >
                  ...
                  <div
                    className={`${classes.services__service} ${
                      this.state.constructResearch.research === "marketing"
                        ? classes["services__service--active"]
                        : null
                    }`}
                  >
                    <h5>
                      ...
                      <button
                        onClick={() => {
                          //this.enrollParticipants("marketing");
                          this.props.updateResearchMainSettings(
                            "research",
                            "marketing"
                          );
                  ...
                  <div
                    className={`${classes.services__service} ${
                      this.state.constructResearch.research === "startup-vcs"
                        ? classes["services__service--active"]
                        : null
                    }`}
                  >
                    <h5>
                      ...
                      <button
                        onClick={() => {
                          //  this.enrollParticipants("startup-vcs");
                          this.props.updateResearchMainSettings(
                            "research",
                            "startup-vcs"
                          );
                ...
                <div className={classes.participants}>
                  ...
                  <div
                    className={`${
                      ...
                      this.state.constructResearch.targetUsersFrom ===
                        "murmur" ||
                      this.state.constructResearch.targetUsersFrom === null
                ...
                <div className={classes["study-conduct"]}>
                  ...
                  <button
                    ...
                    >
                      ...
                      <h5>In Person</h5>
                        <p>
                        Research will be conducted in a physical location in face to face
                        </p>
                    </button>
                    ...
                    >
                      ...
                      <h5>Online via video</h5>
                        <p>
                        Research will be conducted via video session
                        </p>
                      <div className={classes['study-conduct__beta']}>Beta</div>
                    </button>
                    <button
                      className={`${classes["study-conduct__way"]} ${
                        this.state.constructResearch.researchConductedVia ===
                    ...
                    >
                      ...
                      <h5>Over the phone</h5>
                        <p>
                        Research will be conducted via phone call
                        </p>
                      <div className={classes['study-conduct__beta']}>Beta</div>
                    </button>
...
export default connect(null, { updateResearchMainSettings })(
  withRouter(ResearchSetting)
);
